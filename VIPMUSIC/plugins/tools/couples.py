...
@app.on_message(filters.command("couples","jodipura"))
...
🫶🏻 𝐀ᴅᴜᴛʜᴀ  𝐉ᴏᴅɪ 𝐏ᴜʀᴀ  𝐍ᴀʟᴀɪ 𝐒ᴀɴᴛʜɪᴘᴏᴍ 🤞🏻 {tomorrow} !!**
"""
      ...
      # elif is_selected:
      #   msg = await message.reply_text("💐 𝐈ɴʀᴀɪʏᴀ 𝐉ᴏᴅɪ 𝐏ᴜʀᴇ 👩‍❤️‍💋‍👨...")
