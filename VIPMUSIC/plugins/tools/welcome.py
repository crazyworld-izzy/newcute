...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((1820, 1080), f': {user}', fill=(0, 0, 139), font=font)
    draw.text((1820, 1080), f': {user}', fill=None, font=font, stroke_fill=(0, 225, 255), stroke_width=6)
    ...
    draw.text((2000, 1510), f': {uname}', fill=(0, 0, 139), font=font)
    draw.text((2000, 1510), f': {uname}', fill=None, font=font, stroke_fill=(0, 225, 255), stroke_width=6)
