...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((1000, 700), f': {user}', fill=(255, 0, 0), font=font)
    draw.text((1000, 700), f': {user}', fill=None, font=font, stroke_fill=(255, 153, 51), stroke_width=6)
    ...
    draw.text((2000, 1000), f': {uname}', fill=(255, 255, 255), font=font)
    draw.text((2000, 1000), f': {uname}', fill=None, font=font, stroke_fill=(0, 128, 0), stroke_width=6)
