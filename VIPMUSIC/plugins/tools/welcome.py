...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((1820, 1090), f': {user}', fill=(255, 0, 0), font=font)
    draw.text((1820, 1090), f': {user}', fill=None, font=font, stroke_fill=(255, 153, 51), stroke_width=6)
    
    # Draw user's id with shining blue fill and white border
    draw.text((1620, 1290), f': {id}', fill=(0, 0, 139))
    draw.text((1620, 1290), f': {id}', fill=None, font=font, stroke_fill=(247, 0, 255), stroke_width=6)
