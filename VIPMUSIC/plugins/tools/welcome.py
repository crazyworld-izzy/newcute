...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((1800, 950), f': {user}', fill=(255, 0, 0), font=font)
    draw.text((1800, 950), f': {user}', fill=None, font=font, stroke_fill=(255, 153, 51), stroke_width=6)
